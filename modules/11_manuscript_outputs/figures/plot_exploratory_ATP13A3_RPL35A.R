...
# Plot-only reproduction of the exploratory ATP13A3--RPL35A diagnostic.
...
gene_b <- "RPL35A"
pb_p <- 0.9996452
count_p <- 3.506933e-09
detection_p <- 2.214241e-07
sample_seed <- 20260621L
...
output <- file.path(manuscript_root, "figures", "section2", "pair_compare_ATP13A3_RPL35A.pdf")
