...
# Plot-only reproduction of the exploratory ATG7--HACL1 diagnostic.
...
pb_p <- 8.2585e-08
count_p <- 0.922157
detection_p <- 0.9555633
sample_seed <- 20260623L
...
output <- file.path(manuscript_root, "figures", "section2", "pair_compare_ATG7_HACL1.pdf")
